...
@Component
public class GenericOssPayPlugin implements Plugin<PayOrder> {
    private static final Logger logger = LoggerFactory.getLogger(GenericOssPayPlugin.class);
    ...
    private static final class CreatePayOrderTask  implements Task<PayOrder> {
        ...
        public void action(Flow<PayOrder> flow) throws Exception {
            ...
            htmlAttrMap.put("pay_bankcode",attrmap.get("bankCode"));
