...
public class ALIPayPlugin implements Plugin<PayOrder> {
    ...
    public static final class CreateOrderTask implements Task<PayOrder>{
        ...
        public void action(Flow<PayOrder> flow) throws Exception {
            ...
            if (StringUtils.isEmpty(attrmap.get("url"))
                    || StringUtils.isEmpty(attrmap.get("appId"))
            ...
            DefaultAlipayClient alipayClient = new DefaultAlipayClient(attrmap.get("url"),
                    attrmap.get("appId"),
